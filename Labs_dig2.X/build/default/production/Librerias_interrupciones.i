...
# 2 "<built-in>" 2
# 1 "Librerias_interrupciones.c" 2
# 18 "Librerias_interrupciones.c"
...
# 39 "Librerias_interrupciones.c" 2
...
# 40 "Librerias_interrupciones.c" 2
...
int adc_get_channel();
# 41 "Librerias_interrupciones.c" 2
...
int separacacionL(int valueADC);
int separacacionH(int valueADC);
uint8_t tablaHex(int conversion);
# 42 "Librerias_interrupciones.c" 2
